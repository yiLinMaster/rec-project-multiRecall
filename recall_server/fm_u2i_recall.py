...
# 只是将user_feature_embedding和item_feature_embedding保存起来以备后续使用
...
if __name__ == "__main__":
    ...
    article_feature_embedding_file = "./data/fm_article_feature_emb"

    save_redis(read_embedding_file(user_feature_embedding_file), db = 8)
    save_redis(read_embedding_file(article_feature_embedding_file), db = 7)